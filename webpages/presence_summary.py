...
#          print presences
       ...
       presences={'Timestamp':timestamp,'Andrea':0,'Fabrizio':0,'Franco':0,'Giacomo':0,'Giovanni':0,'Vitaliano':0,'Sconosciuto':0}
     else:
...
#                                order_by="Timestamp")
print data_table.ToResponse(columns_order=("Timestamp","Andrea","Fabrizio","Franco","Giacomo","Giovanni","Vitaliano","Sconosciuto"),
